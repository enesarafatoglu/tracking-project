...
<body>
    <h1>Merhaba, Yönetici <?php echo $user['Ad'] . ' ' . $user['Soyad']; ?></h1>
    <table>
        <tr>
            <th>Personel ID:</th>
    ...
    <a href="izin.php">Bireysel İzin Islemleri</a>
    <a href="izintalep.php">Personel İzin Talepleri</a>
    <a href="personel_islem.php">Personel İşlemleri</a>
